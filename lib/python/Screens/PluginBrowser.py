...
config.pluginfilter.italysat = ConfigYesNo(default=False)
config.pluginfilter.clone = ConfigYesNo(default=True)
...
class PluginDownloadBrowser(Screen):
	...
	def createPluginFilter(self):
		...
		if config.pluginfilter.italysat.value:
                        self.PLUGIN_PREFIX2.append(self.PLUGIN_PREFIX + 'italysat')
                if config.pluginfilter.clone.value:
                        self.PLUGIN_PREFIX2.append(self.PLUGIN_PREFIX + 'clone')        
...
class PluginFilter(ConfigListScreen, Screen):
	...
	def createSetup(self):
		...
		self.list.append(getConfigListEntry(_('italysat'), config.pluginfilter.italysat, _('This allows you to show italysat modules in downloads')))
		self.list.append(getConfigListEntry(_('clone'), config.pluginfilter.clone, _('This allows you to show clone drivers modules in downloads')))
